...
class Calculadora(tk.Tk):
    def __init__(self):
        ...
        self.resizable(0,0)
        self.iconbitmap('./Portafolio/ProyectoCalculadora/calculadora.ico')
        # Atributos de clase
        self.expresion =''
        # Caja de texto (input)
        self.entrada = None
